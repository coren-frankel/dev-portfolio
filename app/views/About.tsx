  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          I&apos;m called Coren. I am a Software Developer based in Denver,
          Colorado. I acquired dual bachelors degrees in Philosophy & Political
          Science in 2013 from Northern Arizona University. For the following 8
          years I ascended rank in various roles in the hospitality industy,
          taking pride in my ability to lead through action and deftly solve
          multi-tenanted problems. I have always been a tinkerer, and have
          always had a passion for learning new things, so it was only a matter
          of time before I found my way to programming.
          <Divider
          ...
          TypeScript, and have proven effective with multiple languages and tech
          stacks, not limited to maintaining a proprietary Python eCommerce
          integration. In my short time as a developer I have leveraged my
