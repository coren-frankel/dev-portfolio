...
const Landing = () => {
  ...
  const acceptInputCommand = useCallback((command: string) => {
    if (command.match(/about/i) || command.match(/contact/i) || command.match(/home/i) || command.match(/arcade/i)) {
          ...
          <Typography.Paragraph code className="lime" id="code">
            ...
            <Input
              ...
              styles={{
                ...
                affixWrapper: { border: "none", backgroundColor: "#110", boxShadow: "none" }
              }}
              autoFocus
              autoComplete="none"
